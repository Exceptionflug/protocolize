...
public class ItemsModule {
    ...
    public static void initModule() {
        ...
        ProtocolAPI.getEventManager().registerListener(new HeldItemChangeDownstreamAdapter());
        ProtocolAPI.getEventManager().registerListener(new HeldItemChangeUpstreamAdapter());
    }

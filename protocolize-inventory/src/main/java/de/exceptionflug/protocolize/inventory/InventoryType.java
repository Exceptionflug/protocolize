...
public enum InventoryType {
  ...
  GENERIC_9X1(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 9), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 0, 9)),
  GENERIC_9X2(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 18), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 1, 18)),
  GENERIC_9X3(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 27), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 2, 27)),
  GENERIC_9X4(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 36), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 3, 36)),
  GENERIC_9X5(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 45), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 4, 45)),
  GENERIC_9X6(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:container", 54), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 5, 54)),
  GENERIC_3X3(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:dropper", 9), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 6, 9)),
  ANVIL(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:anvil", 3), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 7, 3)),
  BEACON(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:beacon", 1), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 8, 1)),
  BLAST_FURNACE(new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 9, 2)),
  BREWING_STAND(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_8, "minecraft:brewing_stand", 4), new InventoryIDMapping(MINECRAFT_1_9, MINECRAFT_1_13_2, "minecraft:brewing_stand", 5), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 10, 5)),
  CRAFTING(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:crafting_table", 10), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 11, 10)),
  ENCHANTMENT(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:enchanting_table", 2), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 12, 2)),
  FURNACE(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:furnace", 3), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 13, 3)),
  GRINDSTONE(new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 14, 3)),
  HOPPER(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:hopper", 5), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 15, 5)),
  ...
  MERCHANT(new InventoryIDMapping(MINECRAFT_1_7_2, MINECRAFT_1_13_2, "minecraft:villager", 3), new InventoryIDMapping(MINECRAFT_1_14, MINECRAFT_LATEST, 18, 3)),

...
public class ConfirmTransaction extends AbstractPacket {
  ...
  static {
    ...
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_16_5, 0x11);

    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_2, 0x05);
    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_6, 0x05);
    MAPPING_SERVERBOUND.put(MINECRAFT_1_8, 0x05);
    ...
    MAPPING_SERVERBOUND.put(MINECRAFT_1_16_5, 0x07);
  }

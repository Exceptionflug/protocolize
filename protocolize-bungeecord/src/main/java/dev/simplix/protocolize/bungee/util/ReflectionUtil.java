...
public final class ReflectionUtil {
    ...
    public static Class<?> serverConnectorClass, downstreamBridgeClass, upstreamBridgeClass, serverConnectionClass, pipelineUtilsClass, initialHandlerClass;
    ...
    public static Connection getConnection(final AbstractPacketHandler abstractPacketHandler, final boolean sentToServer) {
        ...
        try {
            ...
            if (serverConnectorClass.isAssignableFrom(abstractPacketHandler.getClass())) {
    ...
    public static ServerInfo getServerInfo(final AbstractPacketHandler packetHandler) {
        if (serverConnectorClass.isAssignableFrom(packetHandler.getClass())) {
            try {
    ...
    public static KickStringWriter getKickStringWriter() throws Exception {
        Field field = pipelineUtilsClass.getDeclaredField("legacyKicker");
        field.setAccessible(true);
        return (KickStringWriter) field.get(null);
    }

    public static boolean isServerConnector(Object obj) {
        return serverConnectorClass.isAssignableFrom(obj.getClass());
    }
